...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/myV5/cms/Cms/App/V5/Tpl/Index/css/css.css"/>
    <script type="text/javascript" src="http://localhost/myV5/cms/Cms/App/V5/Tpl/Index/js/js.js"></script>
    <base target='iframe'/>
</head>
<body>
<div class="nav">
    ...
    <div class="r_menu">
        ...
        <a href="http://localhost/myV5/cms/index.php" target="_blank">前台首页</a>
    </div>
    <!--头部右侧导航-->
</div>
<!--左侧导航-->
